...
function VideoChatApp(props) {
  ...
  if (stream) {
    UserVideo = (
      <Video playsInline muted ref={userVideo} autoPlay style = {{position : "absolute", height: "125px", top:"0px", right: "0px", zIndex:"1000",borderRadius:"20%", border:"1px solid black"}} />
    );
  }
  ...
  if (callAccepted) {
    mainView = (
      <Video playsInline ref={partnerVideo} autoPlay style = {{width: "100%", height: "470px", backgroundColor:"black"}} />
    );
  ...
  return (<Container>
      ...
      <div style = {{position:"absolute",width: "calc(100% - 720px)", height:"250px",marginTop:"20px", backgroundColor:"#ccc"}}> </div>
    </Container>);
}
